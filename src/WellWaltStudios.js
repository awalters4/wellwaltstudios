        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          ...
          <div className="bg-bgLight p-6 rounded-2xl shadow-lg text-center hover:scale-105 transition-transform">
            ...
            >
              <img
                src="/aurova-icon.svg"
                alt="Aurova App"
                className="mx-auto mb-4 rounded-xl w-36"
              />
            </a>
          ...
          <div className="bg-bgLight p-6 rounded-2xl shadow-lg text-center hover:scale-105 transition-transform">
            ...
            <h3 className="text-xl font-heading font-semibold mb-2">
              NBFJA Organizations App
            </h3>
            <p>
              Interactive map with search, images/videos, and the ability to
              find your favorite farmer or co-op across the US.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-secondary px-8 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          ...
          <div className="bg-bgLight p-6 rounded-2xl shadow-lg text-center hover:scale-105 transition-transform">
            ...
            <p>
              IT audits, automation, and strategic tech solutions for small
          ...
          <div className="bg-bgLight p-6 rounded-2xl shadow-lg text-center hover:scale-105 transition-transform">
            ...
            <p>
              Build or maintain web, mobile, database tools, and/or internal
              tool development to bring ideas to life.
            </p>
          </div>
        </div>
